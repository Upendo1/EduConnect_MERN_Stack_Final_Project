  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <section className="max-w-6xl mx-auto px-6 mt-14 pb-16">
        ...
        {user && !loading && resources.length === 0 && !error && (
            <div className="p-6 text-center text-gray-700 mt-10 text-lg bg-white border rounded-xl">
                No resources found.
            </div>
        )}
            ...
            {resources.map((r) => (
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-4">
                  <Link
                    to={/resources/${r._id}} // FIX APPLIED HERE
...
// Component definition moved outside the main function for clarity and correctness
